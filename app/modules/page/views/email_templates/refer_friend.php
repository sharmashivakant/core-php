        ...
        <td class="container">
            <div class="content">
                ...
                <table class="main">
                    ...
                    <tr>
                        <td class="wrapper"><p><strong>{L:EMAIL_TEMP_friend_referring}</strong></p>
                            <p>{L:EMAIL_TEMP_following}</p>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:14px; color:#636363; font-family: Tahoma,sans-serif;">
                                ...
                                <?php if ($this->data['friend_name']) { ?>
                                    <tr>
                                        <td width="40%" style="padding: 10px; border-bottom: 1px solid #cccccc;"><strong>{L:EMAIL_TEMP_Friend_full_name}</strong></td>
                                        <td width="60%" style="padding: 10px; border-bottom: 1px solid #cccccc;"><?= $this->data['friend_name']; ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if ($this->data['friend_email']) { ?>
                                    <tr>
                                        <td width="40%" style="padding: 10px; border-bottom: 1px solid #cccccc;"><strong>{L:EMAIL_TEMP_Friend_email}</strong></td>
                                        <td width="60%" style="padding: 10px; border-bottom: 1px solid #cccccc;"><?= $this->data['friend_email']; ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if ($this->data['friend_tel']) { ?>
                                    <tr>
                                        <td width="40%" style="padding: 10px; border-bottom: 1px solid #cccccc;"><strong>{L:EMAIL_TEMP_Friend_telephone_number}</strong></td>
