...
{
    protected $bullhorn_integration     = ""; //
    protected $bullhorn_password        = ""; //
    protected $bullhorn_client_id       = ""; //
    protected $bullhorn_client_secret   = ""; //
    ...
    public function cronjobAction()
    {
        ...
        if ($access_token && (time() < ($access_token->expires_in + $access_token->time))) {
            ...
            // INSTALLATION: fields must be adjusted if required
            $matrix_vars = array(
                "fl" => implode(",", array(
                    "id",
                    "job_title",
