    ...
    public function addAction()
    {
        ...
        if ($this->startValidation()) {
            ...
            if ($this->isValid()) {
                ...
                if (!$result && $insertID) {
                    Request::addResponse('redirect', false, url('panel', 'sitemap', 'index', $insertID));
                } else {
    ...
    public function editAction()
    {
        ...
        if ($this->startValidation()) {
            ...
            if ($this->isValid()) {
                ...
                if ($result) {
                    Request::addResponse('redirect', false, url('panel', 'sitemap', 'index'));
                } else {
                    Request::returnError('Database error');
                }
            } else {
        ...
        if ($this->startValidation()) {
            ...
            if ($this->isValid()) {
                ...
                if ($links) {
                    ...
                    if (!AnalyticsModel::count_rows('sitemap_links')) {
...
//                Request::addResponse('redirect', false, url('panel', 'sitemap'));
