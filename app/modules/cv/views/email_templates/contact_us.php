        ...
        <td class="container">
            <div class="content">
                ...
                <table class="main">
                    ...
                    <tr>
                        <td class="wrapper">
                            <?php if (@$this->data['page_type']) { ?>
                            <p><strong>New request received from website</strong></p>
                            <p>The following person has submited the form.</p>
                        <?php } else { ?>
                            <p><strong>Submited Contact Us form</strong></p>
                            <p>The following person has submited Contact Us form.</p>
                         <?php } ?>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:14px; color:#636363; font-family: Tahoma,sans-serif;">
                                ...
                                <?php if ($this->data['phone']) { ?>
                                    <tr>
                                        ...
                                        <td width="60%" style="padding: 10px; border-bottom: 1px solid #cccccc;"><?= $this->data['phone']; ?></td>
                                    </tr>
                                <?php } ?>
                                ...
                                <?php if (@$this->data['page_type']) { ?>
                                    <tr>
                                        <td width="40%" style="padding: 10px; border-bottom: 1px solid #cccccc;"><strong>Request From</strong></td>
                                        <td width="60%" style="padding: 10px; border-bottom: 1px solid #cccccc;"><?= $this->data['page_type']; ?></td>
                                    </tr>
                                <?php } ?>
                                <?php if (@$this->data['form_type']) { ?>
                                    <tr>
                                        <td width="40%" style="padding: 10px; border-bottom: 1px solid #cccccc;"><strong>Type</strong></td>
                                        <td width="60%" style="padding: 10px; border-bottom: 1px solid #cccccc;"><?= $this->data['form_type']; ?></td>
                                    </tr>
                                <?php } ?>
