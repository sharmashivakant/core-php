        ...
        <div class="row layout-top-spacing">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    <div class="widget-header">
                        <h1 class="page_title"><a href="{URL:panel/microsites/offices/index/<?= $this->edit->microsite_id; ?>}">Office</a> » Edit</h1>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    <div class="widget-header">
                        <div>
                            <button type="submit" name="submit" class="btn btn-success" onclick="load('panel/microsites/offices/edit/<?= $this->edit->id; ?>', 'form:#form_box'); return false;"><i class="fas fa-save"></i>Save Changes</button>
                            <a class="btn btn-outline-warning" href="{URL:panel/microsites/offices/index/<?= $this->edit->microsite_id; ?>}"><i class="fas fa-ban"></i>Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=<?php echo isset($this->maps_api->value) && $this->maps_api->value ? $this->maps_api->value : ''; ?>&callback=init_geocoder"></script>
