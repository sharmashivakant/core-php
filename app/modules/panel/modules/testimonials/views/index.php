                        ...
                        <?php if (isset($this->list) && is_array($this->list) && count($this->list)) { ?>
                            <?php foreach ($this->list as $item) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if($item->image!=''){?>
                                            <img src="<?= _SITEDIR_; ?>data/testimonials/<?= post('image', false, $item->image); ?>" alt="<?= $item->image ?>" height="50px" width="80px">
                                       <?php  }?>
                                        </td>
                                    <td class="option__buttons">
                                        <a href="{URL:panel/testimonials/edit/<?= $item->id; ?>}" class="bs-tooltip fa fa-pencil-alt" title="Edit"></a>
                                        <a href="{URL:panel/testimonials/delete/<?= $item->id; ?>}" class="bs-tooltip fa fa-trash" title="Delete"></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        <?php } ?>
