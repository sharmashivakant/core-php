        ...
        <td class="container">
            <div class="content">
                ...
                <table class="main">
                    ...
                    <tr>
                        <td class="wrapper"><p><strong>New request received from website</strong></p>
                            <p>The following person has submitted the form.</p>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:14px; color:#636363; font-family: Tahoma,sans-serif;">
                                <?php if ($this->uvid) { ?>
                                    <tr>
                                        ...
                                        <td width="60%" style="padding: 10px; border-bottom: 1px solid #cccccc;"><a href="<?= SITE_URL . 'panel/uploaded_vacancies/edit/' . $this->uvid; ?>" target="_blank">ID: <?= $this->uvid; ?></a></td>
                                    </tr>
                                <?php } ?>
