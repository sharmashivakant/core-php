                            ...
                            <?php foreach ($this->list as $item) { ?>
                                <tr>
                                    ...
                                    <td class="option__buttons">
                                        <a href="{URL:panel/microsites/photos/edit/<?= $item->id; ?>}" class="bs-tooltip fa fa-pencil-alt" title="Edit"></a>
                                        <a href="{URL:panel/microsites/photos/delete/<?= $item->id; ?>}" class="bs-tooltip fa fa-trash" title="Delete"></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        <?php } ?>
