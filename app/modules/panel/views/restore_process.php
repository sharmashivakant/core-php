                        ...
                        <div class="form">
                            ...
                            <div class="d-sm-flex justify-content-between">
                                ...
                                <div class="field-wrapper">
                                    <button type="submit" name="login" onclick="load('panel/restore_process?email=<?= $_GET['email'] ?>&hash=<?= $_GET['hash'] ?>', 'form:#restore_form'); return false;" class="btn btn-primary" value="">Submit</button>
                                </div>
                            </div>
                        </div>
                    </form>
