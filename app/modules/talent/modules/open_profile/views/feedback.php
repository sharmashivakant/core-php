...
<form id="apply_form" class="popup-form">
    ...
    <button class="outline-grey-btn" type="submit" onclick="load('feedback/<?= $this->profile->id ?>', 'form:#apply_form', 'rating#rating-input', 'feedback#feedback'); return false;">SUBMIT</button>
</form>
