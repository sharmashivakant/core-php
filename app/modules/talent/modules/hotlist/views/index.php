<section class="head-inner">
    ...
    <div class="fixed">
        <div class="fixed_2">
            <h1 class="title-page fade-scroll top-scroll" data-scroll><?= $this->list->name ?></h1>
            <h3 class="title-name-page fade-scroll top-scroll"
                data-scroll><?= reFilter($this->list->description) ?></h3>
        </div>
    </div>
</section>
                            ...
                            <li>
                                <div class="box-sec">
                                    ...
                                    <div class="box-bottom-line">
                                        <div class="bs-flex">
                                            <h2 class="bs-sub-head">Represented
                                                by<br><?= $item->consultant->firstname . ' ' . $item->consultant->lastname ?>
                                            </h2>
                                            <div class="bs-pic">
                                                <div style="background-image: url(<?= _SITEDIR_ ?>data/users/<?= $item->consultant->image ?>)"></div>
                                            </div>
                                        </div>
                                        <a href="{URL:talent/anonymous_profile/<?= $item->id ?>}"
                                           class="btn-center btn-yellow">view candidate</a>
                                    </div>
                                </div>
                            </li>
                        <?php } ?>
                        ...
                        <?php foreach ($this->open_profiles as $item) { ?>
                            <li>
                                <div class="box-sec">
                                    ...
                                    <a href="{URL:talent/open_profile/<?= $item->id ?>}" class="btn-center btn-yellow">view
                                        candidate</a>
                            </li>
                        <?php } ?>
                    <?php } ?>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12">
                    <div class="cc-flex">
                        ...
                        <a href="#" data-toggle="modal" data-target="#candidate_alert" class="btn-yellow btn-inline">register
                            candidate alert</a>
                    </div>
                    <p>Simply sign up for "candidate alerts" here, and as soon as we find your ideal candidate profile,
                        you'll immediately be alerted!</p>
                </div>
            </div>
        </div>
    </div>
