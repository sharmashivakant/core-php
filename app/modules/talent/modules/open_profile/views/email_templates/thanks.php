                           ...
                           <tr>
                              <td align="left" valign="top" width="100%">
                                 ...
                                 <table class="responsive-table" width="100%" style="max-width:650px;" border="0" cellspacing="0"
                                    cellpadding="0">
                                    <tr>
                                       <td class="container-inner" bgcolor="#ffff00" style="background-color: #ffff00; padding:40px 42px;">
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                             ...
                                             <tr>
                                                <td
                                                   ...
                                                   Thank you for Contacting <a style="color:#000;" href="<?= SITE_URL; ?>" target="_blank"></a> <?php echo SITE_NAME;?>.
