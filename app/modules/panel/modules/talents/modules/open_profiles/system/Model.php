...
class Open_profilesModel extends Model
{
    ...
    {
        $queries = array(
            "CREATE TABLE `talent_open_profiles` (
    ...
    public function module_update($version)
    {
        ...
        switch ($version) {
            case '0':
                $queries[] = "CREATE TABLE `talent_open_profiles_languages` (
                              `id` int(11) NOT NULL AUTO_INCREMENT,
                              `open_profile_id` int(11) NOT NULL,
                              `language_id` int(11) NOT NULL,
                               PRIMARY KEY (`id`)
                            ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 AUTO_INCREMENT=1 COLLATE=utf8mb4_unicode_ci ;";
                $queries[] = "CREATE TABLE `talent_open_profiles_skills` (
                              `id` int(11) NOT NULL AUTO_INCREMENT,
                              `open_profile_id` int(11) NOT NULL,
                              `skill_id` int(11) NOT NULL,
                               PRIMARY KEY (`id`)
                            ) ENGINE=InnoDB DEFAULT CHARSET=latin1;";
                $queries[] = "CREATE TABLE `talent_open_profiles_locations` (
                              `id` int(11) NOT NULL AUTO_INCREMENT,
                              `open_profile_id` int(11) NOT NULL,
            ...
            case '1':
                $queries[] = "CREATE TABLE IF NOT EXISTS `talent_locations` (
