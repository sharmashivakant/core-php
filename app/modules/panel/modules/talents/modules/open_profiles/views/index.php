                            ...
                            <?php foreach ($this->list as $item) { ?>
                                <tr>
                                    ...
                                    <td class="option__buttons">
                                        <a href="{URL:panel/talents/open_profiles/edit/<?= $item->id; ?>}" class="bs-tooltip fa fa-pencil-alt" title="Edit"></a>
                                        <a href="{URL:talent/open_profile/<?= $item->id; ?>}" class="bs-tooltip fa fa-eye" title="View Profile" target="_blank"></a>
                                        <a href="{URL:panel/talents/open_profiles/delete/<?= $item->id; ?>}" class="bs-tooltip fa fa-trash" title="Delete"></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        <?php } ?>
