                                ...
                                <tr>
                                    ...
                                    <td class="option__buttons">
                                        <?php if ($item->job_spec) { ?>
                                            <a href="<?= _SITEDIR_; ?>data/cvs/<?= $item->job_spec; ?>" class="bs-tooltip fa fa-download" title="Download Job Spec"></a>
                                        <?php } ?>
                                        <?php if ($item->cv) { ?>
                                            <a href="<?= _SITEDIR_; ?>data/cvs/<?= $item->cv; ?>" class="bs-tooltip fa fa-download" title="Download CV"></a>
                                        <?php } ?>
                                        <a href="{URL:panel/uploaded_vacancies/edit/<?= $item->id; ?>}" class="bs-tooltip fa fa-pencil-alt" title="Edit"></a>
                                        <a href="{URL:panel/uploaded_vacancies/delete/<?= $item->id; ?>}" class="bs-tooltip fa fa-trash" title="Delete"></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        <?php } ?>
