...
final class Core
{
    ...
    private function includeFiles()
    {
        ...
        include_once(_SYSDIR_ . 'system/inc/Validator.php'); // Form validator
    ...
    private function getRoute()
    {
        ...
        //Request::setRoute($router); // Set route
