                        ...
                        <?php if (isset($this->list) && is_array($this->list) && count($this->list)) { ?>
                            <?php foreach ($this->list as $item) { ?>
                                <tr>
                                    ...
                                    <!-- <td>
                                        <span style="color:<?= $item->color_code; ?> "><i class="fa fa-circle"></i></span>
                                    </td> -->           
                                    <td class="option__buttons">
                                        <a href="{URL:panel/blog/categories/edit/<?= $item->id; ?>}" class="bs-tooltip fa fa-pencil-alt" title="Edit"></a>
                                        <a href="{URL:panel/blog/categories/delete/<?= $item->id; ?>}" class="bs-tooltip fa fa-trash" title="Delete"></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        <?php } ?>
