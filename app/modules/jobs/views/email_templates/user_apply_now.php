         ...
         <tr>
            <td align="center" valign="top">
                                 ...
                                 <table class="responsive-table" width="100%" style="max-width:650px;" border="0" cellspacing="0"
                                    cellpadding="0">
                                    <tr>
                                       <td class="container-inner" style="background:url(images/email-bg.jpg) right top no-repeat #FFFF00; background-size: cover; padding:40px 42px;">
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                             ...
                                             <tr>
                                                <td
                                                   style="font-family: 'Montserrat', sans-serif; font-size: 18px; line-height: 28px; color: #000; font-weight: 500; padding-bottom: 20px;">
                                                  Thank you for applying <a style="color:#000;" href="<?= SITE_URL . 'jobs/view/' . $this->job->slug; ?>" target="_blank"><?= $this->job->title; ?></a> <?php echo SITE_NAME;?> 
                                                </td>
                                             </tr>
                                             <tr>
                                                <td
                                             ...
                                             <tr>
                                                <td style="padding: 25px 0 0;">
                                                   ...
                                                   <img src="<?=SITE_URL?>app/public/images/email-logo.png" style="width: 300px; height: 60px;" alt="<?php echo SITE_NAME;?>">
                                                   </a>
                                                </td>
                                             </tr>
                                             <tr>
