        ...
        <div class="row layout-top-spacing">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    <div class="widget-header">
                        <h1 class="page_title"><a href="{URL:panel/talents/anonymous_profiles}">Profile</a>&nbsp;» Edit</h1>
                    </div>
                </div>
            </div>
                                ...
                                <?php if (isset($this->hotlists) && is_array($this->hotlists) && count($this->hotlists) > 0) { ?>
                                    <?php foreach ($this->hotlists as $item) { ?>
                                        <div class="custom-control custom-checkbox checkbox-info">
                                            ...
                                            <label class="custom-control-label" for="hotlist_<?=$item->id?>"><?= $item->name; ?></label>
                                        </div>
                                    <?php } ?>
                                <?php } ?>
                            </div>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    <div class="widget-header">
                        <div>
                            <button type="submit" name="submit" class="btn btn-success" onclick="setTextareaValue(); load('panel/talents/anonymous_profiles/edit/<?= $this->user->id; ?>', 'form:#form_box'); return false;"><i class="fas fa-save"></i>Save Changes</button>
