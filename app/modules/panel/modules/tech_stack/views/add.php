<div id="control-container">
    ...
    <h1>
        <i class="fas fa-users"></i>Tech Stack <i class="fas fa-caret-right"></i>New
    </h1>
    <hr/>
    ...
    <form id="form_box" action="{URL:panel/tech_stack/add}" method="post" enctype="multipart/form-data">
        <div class="form-section">
            ...
            <div class="col half_column_right">
                ...
                <div class="choose-file modern">
                    <input type="hidden" name="image" id="image" value="<?= post('image', false); ?>">
        ...
        <div class="form-section">
            <button type="submit" name="submit" class="btn submit" onclick="load('panel/tech_stack/add', 'form:#form_box'); return false;"><i class="fas fa-save"></i>Save Changes</button>
