                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="option__buttons">
                                                <a href="#" onclick="share_linkedin(this);" data-url="{URL:microsite/<?= $item->ref; ?>}" class="bs-tooltip fa fa-linkedin" title="Share To LinkedIn"></a>
                                                <a href="#" onclick="share_facebook(this);" data-url="{URL:microsite/<?= $item->ref; ?>}" class="bs-tooltip fa fa-facebook" title="Share To Facebook"></a>
                                                <a href="#" onclick="share_twitter(this);" data-url="{URL:microsite/<?= $item->ref; ?>}" class="bs-tooltip fa fa-twitter" title="Share To Twitter"></a>
                                                <a href="#" data-clipboard-text="{URL:microsite/<?= $item->ref; ?>}" class="bs-tooltip copy_btn fa fa-link" title="Copy Link"></a>
                                            </div>
                                        </td>

                                        <!-- <td>
                                             <div class="option__buttons">-->
                                        <!--  <a href="{URL:panel/vacancies/index/<?= $item->id; ?>}" class="bs-tooltip fa fa-briefcase" title="Vacancies"></a>-->
                                        <!--                        <a href="{URL:panel/microsites/content_pages/index/--><?php //echo $item->id; 
                                                                                                                            ?>
                                        <!--}" class="bs-tooltip" title="Content Pages"></a>-->
                                        <!--                        <a href="{URL:panel/microsites/awards/index/--><?php //echo $item->id; 
                                                                                                                    ?>
                                        <!--}" class="bs-tooltip" title="Awards"></a>-->
                                        ...
                                        <td>
                                            <div class="option__buttons">
                                                <a href="{URL:microsite/}<?= $item->ref; ?>" class="bs-tooltip fa fa-eye" title="View microsite" target="_blank"></a>
                                                <a href="{URL:panel/microsites/edit/<?= $item->id; ?>}" class="bs-tooltip fa fa-pencil-alt" title="Edit"></a>
                                                <a href="{URL:panel/microsites/delete/<?= $item->id; ?>}" class="bs-tooltip fa fa-trash" title="Delete"></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php } ?>
