...
<form id="form_box" action="{URL:panel/sitemap/add}" method="post" enctype="multipart/form-data">
        ...
        <div class="row layout-top-spacing">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <div class="flex-btw flex-vb" style="height: 100%;">
                                <div></div>
                                <button type="submit" name="submit" class="btn btn-outline-primary" onclick="load('panel/sitemap/add', 'form:#form_box'); return false;"><i class="fas fa-save"></i>Add Section</button>
                            </div>
                        </div>
                    </div>
                                ...
                                <?php foreach ($this->list as $item) { ?>
                                    <tr>
                                        ...
                                        <td class="option__buttons">
                                            <a href="{URL:panel/sitemap/edit/<?= $item->id; ?>}" class="bs-tooltip fa fa-pencil-alt" title="Edit"></a>
                                            <a href="{URL:panel/sitemap/delete/<?= $item->id; ?>}" class="bs-tooltip fa fa-trash" title="Delete"></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            <?php } ?>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    <div class="widget-header">
                        <div>
                            <a class="btn btn-success" onclick="load('panel/sitemap/save', 'links#links'); return false;"><i class="fas fa-save"></i>Generate Sitemap</a>
