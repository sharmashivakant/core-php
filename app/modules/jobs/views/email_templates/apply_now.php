        ...
        <td class="container">
            <div class="content">
                ...
                <table class="main">
                    ...
                    <tr>
                        <td class="wrapper"><p><strong>Vacancy Application</strong></p>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:14px; color:#636363; font-family: Tahoma,sans-serif;">
                                <?php if ($this->job->id) { ?>
                                    <tr>
                                        <td width="40%" style="padding: 10px; border-bottom: 1px solid #cccccc;"><strong>Job Vacancy</strong></td>
                                        <td width="60%" style="padding: 10px; border-bottom: 1px solid #cccccc;"><a href="<?= SITE_URL . 'jobs/view/' . $this->job->slug; ?>" target="_blank"><?= $this->job->title; ?></a></td>
                                    </tr>
                                <?php } ?>
