...
<form id="apply_form" class="popup-form">
    <div class="pf-flex">
        <div class="pf-column">
            <div class="pf-row">
                ...
                <input class="pf-text-field" type="text" name="name" placeholder="Type you full name">
            </div>
            <div class="pf-row">
    ...
    <button class="btn-yellow" type="submit" onclick="load('jobs/apply_now/<?= $this->job->slug; ?>', 'form:#apply_form'); return false;">APPLY NOW</button>
</form>
