        ...
        <div class="row layout-top-spacing">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    <div class="widget-header">
                        <h1 class="page_title"><a href="{URL:panel/talents/open_profiles}">Profile</a>&nbsp;» Edit</h1>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="contract" id="contract" required>
                                ...
                                <option value="Temporary" <?= checkOptionValue(post('contract'), 'Temporary', $this->user->contract); ?>>Temporary</option>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="flex-btw flex-vc" id="video_file">
                                <div class="choose-file">
                                    ...
                                    <input type="file" accept="video/mp4, video/avi, video/mkv" onchange="initFile(this); load('cv/uploadVideo/', 'name=<?= randomHash(); ?>', 'preview=#video_preview', 'field=#video_f');">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="choose-file modern">
                                ...
                                <input type="file" accept="image/jpeg,image/png,image/gif" onchange="initFile(this); addSpinnerIMG(this); load('panel/upload_image_crop', 'name=<?= randomHash(); ?>', 'path=tmp', 'field=#image');">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="flex-btw flex-vc" id="download">
                                <div class="choose-file">
                                    ...
                                    <input type="file"  onchange="initFile(this); load('cv/upload/', 'name=<?= randomHash(); ?>', 'preview=#file_name', 'field=#file');">
                                    <a class="file-fake"><i class="fas fa-folder-open"></i>Choose file</a>
                                </div>
                            ...
                            <div class="custom-control custom-checkbox checkbox-info">
                                <input class="custom-control-input" type="checkbox" name="is_featured" id="is_featured" value="1" <?php if($this->user->is_featured=='1'){ echo 'checked'; }?> ><label class="custom-control-label" for="is_featured"></label>      
                            </div>-->
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    <div class="widget-header">
                        <div>
                            <button type="submit" name="submit" class="btn btn-success" onclick="setTextareaValue(); load('panel/talents/open_profiles/edit/<?= $this->user->id; ?>', 'form:#form_box'); return false;"><i class="fas fa-save"></i>Save Changes</button>
