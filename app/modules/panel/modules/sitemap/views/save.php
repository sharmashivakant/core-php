...
<!--        <a href="{URL:panel/sitemap/add}" onclick="load('panel/sitemap/add');" class="btn add"><i class="fas fa-ban"></i>Cancel</a>-->
<!--        <div class="clr"></div>-->
<!--    </div>-->
<!--    <h1>-->
...
<!---->
<!---->
<!--    <form id="form_box" action="{URL:panel/sitemap/save}" method="post" enctype="multipart/form-data">-->
...
<!---->
<!--        <div class="form-section">-->
<!--            <button type="submit" name="submit" class="btn submit" onclick="load('panel/sitemap/save', 'form:#form_box'); return false;"><i class="fas fa-save"></i>Save Changes</button>-->
<!--            <a href="{URL:panel/sitemap/add}" onclick="load('panel/sitemap/add');" class="btn cancel"><i class="fas fa-ban"></i>Cancel</a>-->
<!--            <div class="clr"></div>-->
<!--        </div>-->
<!--    </form>-->
<!--</div>-->
