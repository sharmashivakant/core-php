...
class Anonymous_profilesModel extends Model
{
    ...
    {
        $queries = array(
            "CREATE TABLE `talent_anonymous_profiles` (
    ...
    public function module_update($version)
    {
        ...
        switch ($version) {
            case '0':
                $queries[] = "CREATE TABLE `talent_anonymous_profiles_languages` (
                              `id` int(11) NOT NULL AUTO_INCREMENT,
                              `profile_id` int(11) NOT NULL,
                              `language_id` int(11) NOT NULL,
                               PRIMARY KEY (`id`)
                           ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 AUTO_INCREMENT=1 COLLATE=utf8mb4_unicode_ci ;";
                $queries[] = "CREATE TABLE `talent_anonymous_profiles_locations` (
                              `id` int(11) NOT NULL AUTO_INCREMENT,
                              `profile_id` int(11) NOT NULL,
                              `location_id` int(11) NOT NULL,
                               PRIMARY KEY (`id`)
                            ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 AUTO_INCREMENT=1 COLLATE=utf8mb4_unicode_ci ;";
                $queries[] = "CREATE TABLE `talent_anonymous_profiles_skills` (
                              `id` int(11) NOT NULL AUTO_INCREMENT,
                              `profile_id` int(11) NOT NULL,
