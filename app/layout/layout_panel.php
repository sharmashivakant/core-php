...
<head>
    ...
    <link href="<?= _SITEDIR_; ?>plugins/apex/apexcharts.css" rel="stylesheet" type="text/css">
    <link href="<?= _SITEDIR_; ?>assets/css/dashboard/dash_1.css" rel="stylesheet" type="text/css" />
    <link href="<?= _SITEDIR_; ?>public/css/jquery.Jcrop.css" rel="stylesheet" type="text/css" />
    <link href="<?= _SITEDIR_; ?>public/css/additional_styles.css" rel="stylesheet" type="text/css" />
    <!-- toastr -->
    <link href="<?= _SITEDIR_; ?>plugins/notification/snackbar/snackbar.min.css" rel="stylesheet" type="text/css" />
    ...
    <script src="<?= _SITEDIR_; ?>plugins/notification/snackbar/snackbar.min.js"></script>
    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-item theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="{URL:/panel}">
                    <img src="<?= _SITEDIR_; ?>assets/img/logo-yellow.svg" class="navbar-logo" alt="logo">
                </a>
            </li>
            ...
            <li class="nav-item dropdown user-profile-dropdown">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                    ...
                    <?php if (User::get('image')) { ?>
                        <img src="<?= _SITEDIR_; ?>data/users/<?= User::get('image'); ?>" alt="avatar">
                    <?php } else { ?>
...
<script src="<?= _SITEDIR_; ?>bootstrap/js/popper.min.js"></script>
<script src="<?= _SITEDIR_; ?>bootstrap/js/bootstrap.min.js"></script>
<script src="<?= _SITEDIR_; ?>plugins/perfect-scrollbar/perfect-scrollbar.min.js"></script>
