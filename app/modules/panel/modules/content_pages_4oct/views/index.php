                        ...
                        <tbody>
                            <?php if (isset($this->list) && is_array($this->list) && count($this->list)) { ?>
                                ...
                                if($item->module!=''){?>
                                    ...
                                    <tr>
                                        <td>
                                            <a class="pan_tit" href="{URL:panel/content_pages/view}?module=<?= $item->module; ?>">
                                                <strong><?= ucfirst($item->module); ?></strong>
                                            </a>
                                        </td>
                                        <td class="option__buttons">
                                            <a href="{URL:panel/content_pages/view}?module=<?= $item->module; ?>" class="bs-tooltip fa fa-folder-open" title="Open"></a>
                                        </td>
                                    </tr>
                                <?php }} ?>
                            <?php } ?>
