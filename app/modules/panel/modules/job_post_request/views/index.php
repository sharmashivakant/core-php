                            ...
                            <?php foreach ($this->list as $item) { ?>
                                <tr>
                                    ...
                                    <td class="option__buttons">
                                        <?php if ($item->job_specification) { ?>
                                            <a href="<?= _SITEDIR_; ?>data/cvs/<?= $item->job_specification; ?>" class="bs-tooltip fa fa-download" title="Download Job Spec"></a>
                                        <?php } ?>
                                       
                                        <a href="{URL:panel/job_post_request/edit/<?= $item->id; ?>}" class="bs-tooltip fa fa-pencil-alt" title="Edit"></a>
                                        <a href="{URL:panel/job_post_request/delete/<?= $item->id; ?>}" class="bs-tooltip fa fa-trash" title="Delete"></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        <?php } ?>
