...
<form id="apply_form" class="popup-form">
    ...
    <label class="checkBox">
        ...
        <span class="check-title">I consent for The <?= SITE_NAME; ?> to contact me with further info regarding this candidate</span>
    </label>

    <button class="btn-yellow" type="submit" onclick="load('open-request-interview/<?= $this->profile->id; ?>', 'form:#apply_form'); return false;">SUBMIT</button>
</form>
