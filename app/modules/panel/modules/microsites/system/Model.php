...
class MicrositesModel extends Model
{
    ...
    public function module_update($version)
    {
        ...
        switch ($version) {
            case '0':
                $queries[] = "CREATE TABLE IF NOT EXISTS `microsites_sectors` (
                    `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
                ...
                $queries[] = "CREATE TABLE IF NOT EXISTS `microsites_locations` (
                    `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
                    `microsite_id` int(10) unsigned NOT NULL,
                ...
                $queries[] = "CREATE TABLE IF NOT EXISTS `microsites_vacancies` (
                    `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
                    `microsite_id` int(10) unsigned NOT NULL,
            ...
            case '1':
                $queries[] = "CREATE TABLE IF NOT EXISTS `microsites_tag_sectors` (
                    `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
                    `microsite_id` int(10) unsigned NOT NULL,
                    `sector_id` int(10) unsigned NOT NULL,
                    PRIMARY KEY (`id`)
