                            ...
                            <?php foreach ($this->list as $item) { ?>
                                <tr>
                                    ...
                                    <td class="option__buttons">
                                        <a href="{URL:panel/microsites/offices/edit/<?= $item->id; ?>}" class="bs-tooltip fa fa-pencil-alt" title="Edit"></a>
                                        <a href="{URL:panel/microsites/offices/delete/<?= $item->id; ?>}" class="bs-tooltip fa fa-trash" title="Delete"></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        <?php } ?>
