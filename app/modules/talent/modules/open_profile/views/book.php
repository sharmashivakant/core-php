...
<h4 class="title-popup">Request Full Profile & CV</h4>
<form id="apply_form" class="popup-form">
    ...
    <button class="outline-grey-btn" type="submit" onclick="load('open-book/<?= $this->profile->id; ?>', 'form:#apply_form'); return false;">SUBMIT</button>
</form>
