        ...
        <td class="container">
            <div class="content">
                ...
                <table class="main">
                    ...
                    <tr>
                        <td class="wrapper"><p><strong>Contact Us Request</strong></p>
                            <p>The following person has enquired via the website.</p>

                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:14px; color:#636363; font-family: Tahoma,sans-serif;">
                                <?php if ($this->data['first_name']) { ?>
                                <tr>
                                    <td width="40%" style="padding: 10px; border-bottom: 1px solid #cccccc;"><strong>Name</strong></td>
                                    <td width="60%" style="padding: 10px; border-bottom: 1px solid #cccccc;"><?= $this->data['first_name']; ?></td>
                                </tr>
                                <?php } ?>
                                ...
                                <?php if ($this->data['subject']) { ?>
                                    <tr>
                                        <td width="40%" style="padding: 10px; border-bottom: 1px solid #cccccc;"><strong>Subject</strong></td>
                                        <td width="60%" style="padding: 10px; border-bottom: 1px solid #cccccc;"><?= $this->data['subject']; ?></td>
                                    </tr>
                                <?php } ?>
