        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
                ...
                <div class="flex-btw flex-vc mob_fc">
                    <h1>Request from candidate</h1>
                    <div>
                        <!-- <a class="btn btn-primary mb-2 mr-2" onclick="load('panel/uploaded_vacancies/export_data_candidate', 'type=upload'); return false;">
                            ...
                            <?php if (isset($this->list) && is_array($this->list) && count($this->list)) { ?>
                                <?php foreach ($this->list as $item) { ?>
                                    <tr>
                                        ...
                                        <td><?= $item->page_type ? ucfirst(str_replace("_", " ", $item->page_type)) : "-"; ?></td>
                                        <td><?= $item->form_type ? ucfirst(str_replace("_", " ", $item->form_type)) : "-"; ?></td>
