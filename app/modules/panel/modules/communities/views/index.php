        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
                ...
                <div class="flex-btw flex-vc mob_fc">
                    ...
                    <a class="btn btn-primary mb-2 mr-2" href="{URL:panel/communities/add}">
                            ...
                            <?php if (isset($this->list) && is_array($this->list) && count($this->list)) { ?>
                                <?php foreach ($this->list as $item) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="<?= _SITEDIR_; ?>data/events/<?= post('image', false, $item->image); ?>" alt="<?= $item->image ?>" height="50px" width="80px">
                                        </td>
                                        <td class="option__buttons">
                                            <a href="{URL:panel/communities/edit/<?= $item->id; ?>}" class="bs-tooltip fa fa-pencil-alt" title="Edit"></a>
                                            <a href="{URL:panel/communities/delete/<?= $item->id; ?>}" class="bs-tooltip fa fa-trash" title="Delete"></a>
                                        </td>     
                                    </tr>
                                <?php } ?>  
                            <?php } ?>
