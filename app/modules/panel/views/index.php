...
<!--        <script>$(function() { load('panel/vacancies/widget'); });</script>-->
        ...
        <link rel="stylesheet" href="<?= _SITEDIR_; ?>public/css/backend/apexcharts.css"/>
        <style>
...
<?php /*<script src="<?= _SITEDIR_; ?>public/js/backend/apexcharts.min.js"></script>*/ ?>

<!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
<script src="<?= _SITEDIR_; ?>plugins/apex/apexcharts.min.js"></script>
