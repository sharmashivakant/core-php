...
class Anonymous_profileModel extends Model
{
    ...
    public function module_update($version)
    {
        ...
        switch ($version) {
            case '0':
                $queries[] =  "CREATE TABLE IF NOT EXISTS `talent_candidate_alerts` (
                ...
                $queries[] = "CREATE TABLE IF NOT EXISTS `talent_requests` (
            ...
            case '1':
                $queries[] = "ALTER TABLE `talent_anonymous_profiles` ADD FULLTEXT(`availability`, `education`, `postcode`, `quote`, `ref`, `job_title`, `skills`);";
