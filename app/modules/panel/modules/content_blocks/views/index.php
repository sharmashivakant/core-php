<div id="control-container">
    <div id="button-holder">
        <a href="{URL:panel/content_blocks/add}" onclick="load('panel/content_blocks/add');" class="btn add">
            <i class="fas fa-plus-circle"></i> Add New Content Block
        </a>
        <div class="clr"></div>
    </div>
    <h1>
        <i class="fas fa-users"></i>Content Blocks
    </h1>
    <hr/>
        ...
        <?php if (isset($this->list) && is_array($this->list) && count($this->list)) { ?>
            <?php foreach ($this->list as $item) { ?>
                <tr>
                    ...
                    <td align="center">
                        <a href="{URL:panel/content_blocks/edit/<?= $item->id; ?>}" class="icon fa fa-fw fa-pencil-alt tooltip" title="Edit"></a>
                        <a href="{URL:panel/content_blocks/delete/<?= $item->id; ?>}" class="icon fa fa-fw fa-trash tooltip" title="Delete"></a>
                    </td>
                </tr>
            <?php } ?>
        <?php } ?>
