        ...
        <div class="row layout-top-spacing">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    <div class="widget-header">
                        <h1 class="page_title"><a href="{URL:panel/analytics}">Google Analytics</a> » Config</h1>
                    </div>
                </div>
            </div>
            ...
            <div id="flFormsGrid" class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="include_code" id="include_code" required style="width: 100%" rows="10"><?= post('include_code', false, reFilter($this->include_code->value)); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    <div class="widget-header">
                        <div>
                            <a class="btn btn-success" onclick="load('panel/analytics/config', 'form:#form_box'); return false;"><i class="fas fa-save"></i>Save Changes</a>
                            <a class="btn btn-outline-warning" href="{URL:panel/analytics}"><i class="fas fa-ban"></i>Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
