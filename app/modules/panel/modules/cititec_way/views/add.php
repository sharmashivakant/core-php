<form id="form_box" action="{URL:panel/cititec_way/add}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    <div class="widget-header">
                        <h1 class="page_title"><a href="{URL:panel/cititec_way}">Cititec Way</a> » Add</h1>
                    </div>
                </div>
            </div>
         ...
         <div class="form-row">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    <div class="widget-header">
                        <div>
                            <button type="submit" name="submit" class="btn btn-success" onclick="load('panel/cititec_way/add', 'form:#form_box'); return false;">Save Changes</button>
                            <a class="btn btn-outline-warning" href="{URL:panel/cititec_way}">Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
